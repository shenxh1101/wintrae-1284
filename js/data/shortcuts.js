const shortcutData = {
  ...
  challengeShortcuts: [
    { keys: ['Ctrl', 'C'], action: '复制选中文本或文件', category: 'edit' },
    { keys: ['Ctrl', 'V'], action: '粘贴剪贴板内容', category: 'edit' },
    { keys: ['Ctrl', 'X'], action: '剪切选中文本', category: 'edit' },
    { keys: ['Ctrl', 'Z'], action: '撤销上一步操作', category: 'edit' },
    { keys: ['Ctrl', 'Y'], action: '重做刚才撤销的操作', category: 'edit' },
    { keys: ['Ctrl', 'S'], action: '保存当前文件', category: 'file' },
    { keys: ['Ctrl', 'F'], action: '查找内容', category: 'edit' },
    { keys: ['Ctrl', 'A'], action: '全部选中', category: 'edit' },
    { keys: ['Alt', 'Tab'], action: '切换打开的窗口', category: 'window' },
    { keys: ['Ctrl', 'T'], action: '打开新标签页', category: 'navigate' },
    { keys: ['Ctrl', 'W'], action: '关闭当前标签', category: 'navigate' },
    { keys: ['Ctrl', 'Shift', 'T'], action: '恢复刚关闭的标签', category: 'navigate' },
    { keys: ['F5'], action: '刷新页面', category: 'view' },
    { keys: ['Ctrl', 'N'], action: '新建文件或窗口', category: 'file' },
    { keys: ['Ctrl', 'O'], action: '打开文件', category: 'file' },
    { keys: ['Win', 'D'], action: '显示桌面', category: 'window' },
    { keys: ['Win', 'E'], action: '打开文件管理器', category: 'file' },
    { keys: ['Win', 'L'], action: '锁定电脑屏幕', category: 'tool' }
  ]
};
